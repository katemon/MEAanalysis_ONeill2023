...
% 
% some taken from trialEstStats_BGLUsynchData.m
% some taken from plotNetworkParams.m
...
% load
load([theDir,'rmBGLU_injuryRecovery_netwData.mat'],'netwData');


% first set of variables
numConds = length(theConds);
theVars = {'Eglob'; 'Q'; 'nCmnty'};
...
for ii=1:length(theConds)
    ...
    for jj=1:length(recDays)
        ...
        for kk=1:length(netwData.(theConds{ii}).(recDays{jj}))
            
            checkIfEmpty = netwData.(theConds{ii}).(recDays{jj})(kk).allBadChannels;
            
            if ~isempty(checkIfEmpty)
                if strcmp(theConds{ii},'cond0g_0b')
                    counter0g0b = counter0g0b + 1;
                    dataCounter = counter0g0b;
                elseif strcmp(theConds{ii},'cond0g_50b')
                    counter0g50b = counter0g50b + 1;
                    dataCounter = counter0g50b;
                elseif strcmp(theConds{ii},'cond30g_0b')
                    counter30g0b = counter30g0b + 1;
                    dataCounter = counter30g0b;
                elseif strcmp(theConds{ii},'cond30g_50b')
                    counter30g50b = counter30g50b + 1;
                    dataCounter = counter30g50b;
                end %if strcmp
                
                Eglob = netwData.(theConds{ii}).(recDays{jj})(kk).Eglob;
                Q = netwData.(theConds{ii}).(recDays{jj})(kk).Q;
                nCmnty = netwData.(theConds{ii}).(recDays{jj})(kk).nCmnty;
                
                orgData.Eglob.(recDays{jj}).(theConds{ii})(dataCounter) = Eglob;
                orgData.Q.(recDays{jj}).(theConds{ii})(dataCounter) = Q;
                orgData.nCmnty.(recDays{jj}).(theConds{ii})(dataCounter) = nCmnty;
                
            end %if ~isempty
        end %if kk
        
        theData = orgData.Eglob.(recDays{jj}).(theConds{ii});
        orgData.Eglob.(recDays{jj}).(theConds{ii}) = theData';
        clear theData;
        
        theData = orgData.Q.(recDays{jj}).(theConds{ii});
        orgData.Q.(recDays{jj}).(theConds{ii}) = theData';
        clear theData;
        
        theData = orgData.nCmnty.(recDays{jj}).(theConds{ii});
        orgData.nCmnty.(recDays{jj}).(theConds{ii}) = theData';
        clear theData;
...
% Eloc data
clearvars -except netwData orgData theConds recDays numConds ...
    theDir figDir myColors ready2save
    ...
    for jj=1:length(recDays)
        ...
        for kk=1:length(netwData.(theConds{ii}).(recDays{jj}))
            ...
            if ~isempty(checkIfEmpty)
                ...
                ogRows2elim = netwData.(theConds{ii}).(recDays{jj})(kk).allBadChannels;
                ogElecRows = [1:64];
                
                ogElecRows_noDummy = ogElecRows;
                ogElecRows_noDummy([1,5,8,57,64]) = [];
                row1 = find(ogRows2elim==1);
                row2 = find(ogRows2elim==5);
                row3 = find(ogRows2elim==8);
                row4 = find(ogRows2elim==57);
                row5 = find(ogRows2elim==64);
                ogRows2elim_noDummy = ogRows2elim;
                ogRows2elim_noDummy([row1,row2,row3,row4,row5]) = [];
                
                newRows2elim = [];
                if ~isempty(ogRows2elim_noDummy)
                    for mm=1:length(ogRows2elim_noDummy)
                        theRow = find(ogRows2elim_noDummy(mm)==ogElecRows_noDummy);
                        newRows2elim = [newRows2elim, theRow];
                    end %for mm
                end %if ~isempty
                Eloc = netwData.(theConds{ii}).(recDays{jj})(kk).Eloc;
                Eloc(newRows2elim) = [];
                
                orgData.Eloc.(recDays{jj})(dataCounter).(theConds{ii}) = Eloc;
...
if ready2save
    save([figDir,'bgluNetwOrgData.mat'],'orgData');
end %if ready2save

%% PART 1 (est) - plot and do stats 

theVars = {'Eglob'; 'Q'; 'nCmnty'; 'Eloc'};
theConds = {'cond0g_0b', 'cond0g_50b', 'cond30g_0b', 'cond30g_50b'};
...
% yR1 = [-0.2 -0.5 -30 -0.05];
% yR2 = [ 0.2  0.8  30  0.02];
% yLtl1 = [-0.05 -0.25 -0.01];
% yLtl2 = [0.075 0.25 0.03];
%
for ii=1:length(theVars)
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r14_0g_0b,~] = find(div14_0g_0b_old<=0.005);%find(div14_0g_0b_old==0);
        div14_0g_0b(r14_0g_0b) = [];
        div15_0g_0b(r14_0g_0b) = [];
        div17_0g_0b(r14_0g_0b) = [];
    else
        div14_0g_0b = orgData.(thisVar).div14.cond0g_0b;
        div15_0g_0b = orgData.(thisVar).div15.cond0g_0b;
        div17_0g_0b = orgData.(thisVar).div17.cond0g_0b;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r15_0g_0b,~] = find(div15_0g_0b<=0.005);%find(div15_0g_0b==0);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r14_0g_50b,~] = find(div14_0g_50b_old<=0.005);%find(div14_0g_50b_old==0);
        div14_0g_50b(r14_0g_50b) = [];
        div15_0g_50b(r14_0g_50b) = [];
        div17_0g_50b(r14_0g_50b) = [];
    else
        div14_0g_50b = orgData.(thisVar).div14.cond0g_50b;
        div15_0g_50b = orgData.(thisVar).div15.cond0g_50b;
        div17_0g_50b = orgData.(thisVar).div17.cond0g_50b;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r15_0g_50b,~] = find(div15_0g_50b<=0.005);%find(div15_0g_50b==0);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r14_30g_0b,~] = find(div14_30g_0b_old<=0.005);%find(div14_30g_0b_old==0);
        div14_30g_0b(r14_30g_0b) = [];
        div15_30g_0b(r14_30g_0b) = [];
        div17_30g_0b(r14_30g_0b) = [];
    else
        div14_30g_0b = orgData.(thisVar).div14.cond30g_0b;
        div15_30g_0b = orgData.(thisVar).div15.cond30g_0b;
        div17_30g_0b = orgData.(thisVar).div17.cond30g_0b;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r15_30g_0b,~] = find(div15_30g_0b<=0.005);%find(div15_30g_0b==0);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r14_30g_50b,~] = find(div14_30g_50b_old<=0.005);%find(div14_30g_50b_old==0);
        div14_30g_50b(r14_30g_50b) = [];
        div15_30g_50b(r14_30g_50b) = [];
        div17_30g_50b(r14_30g_50b) = [];
    else
        div14_30g_50b = orgData.(thisVar).div14.cond30g_50b;
        div15_30g_50b = orgData.(thisVar).div15.cond30g_50b;
        div17_30g_50b = orgData.(thisVar).div17.cond30g_50b;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        [r15_30g_50b,~] = find(div15_30g_50b<=0.005);%find(div15_30g_50b==0);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        xJitt = jittAmt*rand(length(div14_0g_0b),1)-(jittAmt/2);
        scatter(xJitt+xLocs1(1),div17_0g_0b-div15_0g_0b,scattSz,'ko');
        xJitt = jittAmt*rand(length(div14_0g_50b),1)-(jittAmt/2);
        scatter(xJitt+xLocs1(2),div17_0g_50b-div15_0g_50b,scattSz,'kd');
        xJitt = jittAmt*rand(length(div14_30g_0b),1)-(jittAmt/2);
        scatter(xJitt+xLocs1(3),div17_30g_0b-div15_30g_0b,scattSz,'ro');
        xJitt = jittAmt*rand(length(div14_30g_50b),1)-(jittAmt/2);
        scatter(xJitt+xLocs1(4),div17_30g_50b-div15_30g_50b,scattSz,'rd');
    end %if strcmp
    %     ylim([yR1(ii) yR2(ii)]);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        y = (div17_0g_0b./div15_0g_0b).*100;
        x = (div15_0g_0b./div15_0g_0b).*100;
        myFun = @(y,x) mean(y-x);
        ci3_0g_0b = bootci(nIterations,myFun,y,x);
        y = (div17_0g_50b./div15_0g_50b).*100;
        x = (div15_0g_50b./div15_0g_50b).*100;
        myFun = @(y,x) mean(y-x);
        ci3_0g_50b = bootci(nIterations,myFun,y,x);
        y = (div17_30g_0b./div15_30g_0b).*100;
        x = (div15_30g_0b./div15_30g_0b).*100;
        myFun = @(y,x) mean(y-x);
        ci3_30g_0b = bootci(nIterations,myFun,y,x);
        y = (div17_30g_50b./div15_30g_50b).*100;
        x = (div15_30g_50b./div15_30g_50b).*100;
        myFun = @(y,x) mean(y-x);
        ci3_30g_50b = bootci(nIterations,myFun,y,x);
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        plot(xLocs2(1), mean(100.*((div17_0g_0b-div15_0g_0b)./div15_0g_0b)),'ko','markersize',markerSize,'markerfacecolor','k','linewidth',1.75);
        plot(xLocs2(2), mean(100.*((div17_0g_50b-div15_0g_50b)./div15_0g_50b)),'kd','markersize',markerSize,'markerfacecolor',[1 1 1],'linewidth',1.75);
        plot(xLocs2(3), mean(100.*((div17_30g_0b-div15_30g_0b)./div15_30g_0b)),'ro','markersize',markerSize,'markerfacecolor','r','linewidth',1.75);
        plot(xLocs2(4), mean(100.*((div17_30g_50b-div15_30g_50b)./div15_30g_50b)),'rd','markersize',markerSize,'markerfacecolor',[1 1 1],'linewidth',1.75);
    end %if strcmp
%     ylim([yR1(ii) yR2(ii)]); %ylim([yLtl1(ii) yLtl2(ii)]);
    set(gca,'box','off','tickdir','out');
...
%     ylim([yR1(ii) yR2(ii)]);
    ...
    % *** *** *** %
%     disp([thisVar, ' 24h post vs pre, diff in % change']);
    disp(['0g 0B vs 30g 0B: ',num2str(mean(X2)-mean(X1))]);
    % *** *** *** %
    ...
    % *** *** *** %
%     disp([thisVar, ' 24h post vs pre, diff in % change']);
    disp(['0g 0B vs 30g 50B: ',num2str(mean(X2)-mean(X1))]);
    % *** *** *** %
...
%     ylim([yR1(ii) yR2(ii)]);
    ...
    disp(['0g 0B vs 0g 50B: ',num2str(mean(X2)-mean(X1))]);
    % *** *** *** %
...
%     ylim([yR1(ii) yR2(ii)]);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        X2 = ((div17_0g_50b - div15_0g_50b)./div15_0g_50b).*100;
        X1 = ((div17_0g_0b - div15_0g_0b)./div15_0g_0b).*100;
    end %if strcmp
    n1 = length(X1);
    n2 = length(X2);
    myStatistic = @(X1,X2) mean(X2)-mean(X1);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        X2 = ((div17_30g_0b - div15_30g_0b)./div15_30g_0b).*100;
        X1 = ((div17_0g_0b - div15_0g_0b)./div15_0g_0b).*100;
    end %if strcmp
    n1 = length(X1);
    n2 = length(X2);
...
% save([figDir, 'estStats_bgluNETW.mat'], 'wthnStats','btwnStats');
...
% yL1 =  -0.35;%[-0.2 -1   -45 -0.35];
% yL2 = 0.35;%[ 0.2  1    45  0.35];
% yR1 = -0.025;%[-0.2 -0.5 -30 -0.05];
% yR2 = 0.05;%[ 0.2  0.8  30  0.02];
% yLtl1 = [-0.05 -0.25 -0.01];
% yLtl2 = [0.075 0.25 0.03];
%
for ii=1:length(theVars)
...
%     % STATS %
    ...
    % *** *** *** %
%     disp([thisVar, ' 24h post vs pre, diff in % change']);
    disp(['30g 0B vs 30g 50B: ',num2str(mean(X2)-mean(X1))]);
    % *** *** *** %
    ci1_Diff2 = prctile(bootstrapStat,[100*alpha/2,100*(1-alpha/2)]);
    plot([xLocs1(6) xLocs1(6)], [ci1_Diff2(1) ci1_Diff2(2)],'k-','linewidth',1.25);
    plot(xLocs1(6), mean(X2)-mean(X1),'ks','markersize',markerSize,'markerfacecolor',[0 0 0],'linewidth',1.75);
...
%     % 0g0B vs 30g50B
%     if strcmp(thisVar,'Eloc')
%         X2 = ((div17_30g_50b_other - div15_30g5_0b_other)./div15_30g5_0b_other).*100;
%         X1 = ((div17_0g_0b_other - div15_0g_0b_other)./div15_0g_0b_other).*100;
%     else
%         X2 = ((div17_30g_50b - div15_30g_50b)./div15_30g_50b).*100;
%         X1 = ((div17_0g_0b - div15_0g_0b)./div15_0g_0b).*100;
...
% save([figDir, 'estStats_bgluNETW_withinInjury.mat'], 'wthnStats','btwnStats');
