...
% version (_v2) uses datastrm while the other version (_v1) uses the %%%%%%
% getraw_uv function. You may need to use one or the other depending on %%%
% your computer and version of MATLAB. %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
addpath('\analyze_mcd\');
addpath('\mcs_related\');
addpath('\mcs_related\html\');
addpath('\mcs_related\mcintfac\');
...
for ii=1:NumMEAs
    ...
    savelocation = 'E:\MEA Data\29032021 dissection\';
    ...
    directory_root = uigetdir('E:\MEA Data\29032021 dissection\', 'Choose RAW data MEA directory'); %choose directory with particular MEA;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	totaltime = 300; %5min of recording
    for jj=1:NumFiles
        ...
        dataInfo = datastrm(RawFileLocs{jj,1}); % update 2021-05-21
		
        for zz=1:ChunkSize:totaltime*1000 %in msec
            Time = [zz,zz+ChunkSize];
            
            chunkInfo = nextdata(dataInfo,'startend',Time,'streamname','Electrode Raw Data'); % update 2021-05-21
            DataChunk = chunkInfo.data; % update 2021-05-21
    ...
    for kk=1:NumFiles-1
        ...
        [NumBurstlets, ISI_perE, ISI_overall, IBI_perE, IBI_overall, bwidth_iter, bwidth_time, ...
            ...
            EBurstArray, globalBursts_beginI, globalBursts_endI, globalBursts_Elecs, ...
			globalBursts_NumBInGB, globalBursts_width_iter, globalBursts_AvgWidth_iter, ...
			...
			= detectbursts(SpikeVoltage, SpikeTime, SpikeElectrode, SpikeIter, fs, numits, totaltime);
