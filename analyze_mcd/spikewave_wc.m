function [patch_Vrange, patch_Irange, numtoelim] = spikewave_wc(thesespikes, ...
    fileloc,chunknum,filtereddata,chunksize,spikeiter,spikeelectrode,totalT, ...
    fs,numChannels)
...
totaltime = totalT*1000; %total recording time in msec
...
patch_Vrange = zeros(chunkspikes,numChannels);
patch_Irange = zeros(chunkspikes,numChannels);
