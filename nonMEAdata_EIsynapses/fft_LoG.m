...
function [prefAng, filIm, maxProjIm, mask] = fft_LoG(filSig,numSig,numAngs,thrMult,im)
...
%     filIm = filIm((padSize2(1) + 1):(end - padSize2(1)), (padSize2(2) + 1):(end - padSize2(2)), :);
    newfilIm = filIm((padSize2(1) + 2):(end - (padSize2(1)+1)), (padSize2(2) + 2):(end - (padSize2(2)+1)), :);
    filIm = newfilIm;
