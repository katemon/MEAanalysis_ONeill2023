...
% yL1 = [-0.15 -0.6 -40 -0.25];
% yL2 = [ 0.15  0.6  40 0.25];
% yR1 = [-0.1 -0.4 -25 -0.04];
% yR2 = [ 0.1  0.4  25 0.04];
...
for ii=1:length(theVars)
    ...
    if strcmp(thisVar,'Eloc')
        ...
        div07_0B = orgData.(thisVar).div07.cond0B;
        div10_0B = orgData.(thisVar).div10.cond0B;
        div17_0B = orgData.(thisVar).div17.cond0B;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        div07_25B = orgData.(thisVar).div07.cond25B;
        div10_25B = orgData.(thisVar).div10.cond25B;
        div17_25B = orgData.(thisVar).div17.cond25B;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        div07_50B = orgData.(thisVar).div07.cond50B;
        div10_50B = orgData.(thisVar).div10.cond50B;
        div17_50B = orgData.(thisVar).div17.cond50B;
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        y = (div17_0B./div10_0B).*100;
        x = (div10_0B./div10_0B).*100;
        myFun = @(y,x) mean(y-x);
        ci3_0B = bootci(nIterations,myFun,y,x);
        y = (div17_25B./div10_25B).*100;
        x = (div10_25B./div10_25B).*100;
        myFun = @(y,x) mean(y-x);
        ci3_25B = bootci(nIterations,myFun,y,x);
        y = (div17_50B./div10_50B).*100;
        x = (div10_50B./div10_50B).*100;
        myFun = @(y,x) mean(y-x);
        ci3_50B = bootci(nIterations,myFun,y,x);
    end %if strcmp
    ...
    if strcmp(thisVar,'Eloc')
        ...
        plot(xLocs2(1), mean(100.*((div17_0B-div10_0B)./div10_0B)),'ko','markersize',markerSize,'markerfacecolor','k','linewidth',1.75);
        plot(xLocs2(2), mean(100.*((div17_25B-div10_25B)./div10_25B)),'ro','markersize',markerSize,'markerfacecolor','r','linewidth',1.75);
        plot(xLocs2(3), mean(100.*((div17_50B-div10_50B)./div10_50B)),'bo','markersize',markerSize,'markerfacecolor','b','linewidth',1.75);
    end %if strcmp
...
%     disp([thisVar, ' div17 vs div07, diff in % change']);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        X2 = ((div17_25B - div10_25B)./div10_25B).*100;
        X1 = ((div17_0B - div10_0B)./div10_0B).*100;
    end %if strcmp
    n1 = length(X1);
    n2 = length(X2);
    myStatistic = @(X1,X2) mean(X2)-mean(X1);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        X2 = ((div17_50B - div10_50B)./div10_50B).*100;
        X1 = ((div17_0B - div10_0B)./div10_0B).*100;
    end %if strcmp
    n1 = length(X1);
    n2 = length(X2);
...
%     disp([thisVar, ' div17 vs div10, diff in % change']);
    ...
    if strcmp(thisVar,'Eloc')
        ...
        X2 = ((div17_50B - div10_50B)./div10_50B).*100;
        X1 = ((div17_25B - div10_25B)./div10_25B).*100;
    end %if strcmp
    n1 = length(X1);
    n2 = length(X2);
    myStatistic = @(X1,X2) mean(X2)-mean(X1);
...
% save([figDir, 'estStats_bdnfNetw.mat'], 'wthnStats','btwnStats');
