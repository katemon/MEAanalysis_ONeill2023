%% part 1 - BDNF DOSE RESPONSE - plot est stats by subtracting from control

clc; clear all; close all;

theDir = 'C:\Users\kmfo8\Dropbox\Rutgers\Firestein Lab\Manuscript DRAFTS\2022 BDNF MEA paper\figures\data - BDNF dose response\revision_0B25B50Bonly_newPlots\data\';%'D:\kate_dropbox\
figDir = 'C:\Users\kmfo8\Dropbox\Rutgers\Firestein Lab\Manuscript DRAFTS\2022 BDNF MEA paper\figures\data - BDNF dose response\revision_0B25B50Bonly_newPlots\data\figs_estStats\';%'D:\kate_dropbox\
...
spkThr = 0.2; % spike thresh is 50 spikes per recording
brstThr = 0.02; % 1 burstlet every 20 sec
gbThr = 0.01; % global burst

markerSize = 8;

% yL1 = [-12  -0.75  -250 -1 -5];
% yL2 = [ 12   0.75   250  1  10];
% yR1 = [-0.6 -0.06  -70  -0.07  -0.75];
% yR2 = [ 0.6  0.06   70   0.07   1.25];
% yLtl1 = [-0.5];
% yLtl2 = [1.5];
%%
for ii=1:length(varNames)
    ...
    % *** *** *** %
    plot(xLocs2(1), mean(100.*((div10_0B-div07_0B)./div07_0B)),'ko','markersize',10,'markerfacecolor','k','linewidth',1.75);
    plot(xLocs2(2), mean(100.*((div10_25B-div07_25B)./div07_25B)),'ro','markersize',10,'markerfacecolor','r','linewidth',1.75);
    plot(xLocs2(3), mean(100.*((div10_50B-div07_50B)./div07_50B)),'bo','markersize',10,'markerfacecolor','b','linewidth',1.75);
    if ii==1
    ...
    % *** *** *** %
    plot(xLocs2(1), mean(100.*((div17_0B-div07_0B)./div07_0B)),'ko','markersize',10,'markerfacecolor','k','linewidth',1.75);
    plot(xLocs2(2), mean(100.*((div17_25B-div07_25B)./div07_25B)),'ro','markersize',10,'markerfacecolor','r','linewidth',1.75);
    plot(xLocs2(3), mean(100.*((div17_50B-div07_50B)./div07_50B)),'bo','markersize',10,'markerfacecolor','b','linewidth',1.75);
    if ii==1
        %         ylim([yLtl1(1) yLtl2(1)]);
        %     yticks([-0.05, -0.025, 0, 0.025, 0.05, 0.075]);
        %     yticklabels({'-0.05','','0','','0.05',''});
    ...
    % *** *** *** %
    disp([thisVar, ' div10 vs div17 mean % change']);
    ...
    % *** *** *** %
    plot(xLocs2(1), mean(100.*((div17_0B_other-div10_0B_other)./div10_0B_other)),'ko','markersize',10,'markerfacecolor','k','linewidth',1.75);
    plot(xLocs2(2), mean(100.*((div17_25B_other-div10_25B_other)./div10_25B_other)),'ro','markersize',10,'markerfacecolor','r','linewidth',1.75);
    plot(xLocs2(3), mean(100.*((div17_50B_other-div10_50B_other)./div10_50B_other)),'bo','markersize',10,'markerfacecolor','b','linewidth',1.75);
    if ii==5
        %         ylim([yLtl1(1) yLtl2(1)]);
    else
        %         ylim([yR1(ii) yR2(ii)]);
